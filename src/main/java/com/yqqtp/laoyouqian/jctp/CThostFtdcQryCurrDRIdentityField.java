...
public class CThostFtdcQryCurrDRIdentityField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        ctpapiv6v3v11JNI.delete_CThostFtdcQryCurrDRIdentityField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setDRIdentityID(int value) {
    ctpapiv6v3v11JNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_set(swigCPtr, this, value);
  }

  public int getDRIdentityID() {
    return ctpapiv6v3v11JNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_get(swigCPtr, this);
  }

  public CThostFtdcQryCurrDRIdentityField() {
    this(ctpapiv6v3v11JNI.new_CThostFtdcQryCurrDRIdentityField(), true);
  }
